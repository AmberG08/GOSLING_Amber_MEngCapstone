...
plt.scatter(sorted_comparison_df.index, sorted_comparison_df['Actual'], label = 'Actual Values', s=1)
plt.scatter(sorted_comparison_df.index, sorted_comparison_df['Predicted'], color = 'c', label = 'Predictions', s=1)
